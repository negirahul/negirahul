                                            ...
                                            <td class="text-center">
                                               <div class="input-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li><a class="dropdown-item" href="{{ route('super-admin.assessment-status.kypform', ['claim_id' => $claim->id]) }}">
                                                            <i class="mdi mdi-pencil"></i> Assessment Form Part I</a>
                                                        </li>

                                                        <li><a class="dropdown-item" href="{{ route('super-admin.assessment-status.treatmentform', ['claim_id' => $claim->id]) }}">
                                                            <i class="mdi mdi-pencil"></i> Assessment Form Part II</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
